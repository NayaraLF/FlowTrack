  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        <Dumbbell size={80} color="#ffffff" strokeWidth={1.5} style={{ transform: 'rotate(-45deg)', marginBottom: '0.5rem' }} />
        <h1 style={{ color: '#ffffff', fontSize: '3rem', fontFamily: '"Stylish", serif', margin: 0 }}>FlowTrack</h1>
      </div>

      <div style={{ width: '100%', maxWidth: '320px', paddingBottom: '2rem' }}>
        <h2 style={{ color: '#fff', textAlign: 'center', marginBottom: '1.5rem', fontSize: '1.5rem' }}>Create Account</h2>
